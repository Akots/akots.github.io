...
(function($) 
{
  Jobber = {
    ...
    HandleOtherSchool: function()
    {
      if($("#other_school").is(":visible"))
      {
        $("#education_school_id").removeAttr("disabled");
        $("div#other_school").hide();
        $("a#other_school_label").html("other");
      }
      else
      {
        $("#education_school_id").attr("disabled", "disabled");
        $("div#other_school").show();
        $("#education_school_name").focus();
        $("a#other_school_label").html("pick one from the list");
      }
    },
