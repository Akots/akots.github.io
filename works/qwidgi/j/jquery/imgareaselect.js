...
jQuery.imgAreaSelect = function (img, options) {
    var $area = jQuery('<div class="imgAreaSelect area"></div>'),
        $border1 = jQuery('<div class="imgAreaSelect border1"></div>'),
        $border2 = jQuery('<div class="imgAreaSelect border2"></div>'),
        $outLeft = jQuery('<div class="imgAreaSelect outLeft"></div>'),
        $outTop = jQuery('<div class="imgAreaSelect outTop"></div>'),
        $outRight = jQuery('<div class="imgAreaSelect outRight"></div>'),
        $outBottom = jQuery('<div class="imgAreaSelect outBottom"></div>'),
        imgOfs, imgWidth, imgHeight, zIndex = 3000, fixed = false, $p,
...
jQuery.fn.imgAreaSelect = function (options) {
    ...
    this.each(function () {
        if (jQuery(this).data('imgAreaSelect'))
        {
            ...
            ias = jQuery(this).data('imgAreaSelect');
        }
        else {
            if (options.enable === undefined && options.disable === undefined)
                options.enable = true;

                  ias = new jQuery.imgAreaSelect(this, options);

            jQuery(this).data('imgAreaSelect', ias);
        }
    });
