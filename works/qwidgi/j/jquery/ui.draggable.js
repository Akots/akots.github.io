...
$.widget("ui.draggable", $.extend({}, $.ui.mouse, {
   ...
   mouseStart: function(e) {
      ...
      typeof(o.afterStart) != 'undefined' && $.isFunction(o.afterStart) ? o.afterStart(this.helper, this.element) : '';
   ...
   mouseStop: function(e) {
      ...
      if ($.ui.ddmanager && !this.options.dropBehaviour)
         dropped = $.ui.ddmanager.drop(this, e);
      ...
      typeof(this.options.afterStop) != 'undefined' && $.isFunction(this.options.afterStop) ? this.options.afterStop(this.helper, this.element, dropped) : '';
